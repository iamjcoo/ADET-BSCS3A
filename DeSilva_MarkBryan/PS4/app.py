...
def register():
    if request.method == 'POST':
        ...
        cursor.execute("INSERT INTO adet_user (first_name, middle_name, last_name, contact_number, email_address, address, password) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
def dashboard():
    ...
    cursor = db.cursor()
    cursor.execute("SELECT first_name, last_name, email_address FROM adet_user WHERE user_id = %s", (session['user_id'],))
